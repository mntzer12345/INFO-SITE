...
echo -e $red "                                    ";
echo -e $green " The Script By:$red MNTZER-ANWER"
echo -e $green "      TELEGREM:$red MNTZER_18"
echo
echo
...
echo
echo
echo -e $green "         TELEGRAM:$red MNTZER_18"
echo -e $green "         FACEBOOK:$red MNTZER.ANWER18"
echo -e $green "         INSTGRAM:$red 313.JS"
echo
echo
echo
echo
